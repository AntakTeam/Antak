...
local Get_Files, res = https.request("https://raw.githubusercontent.com/WaTaNTeaM/AntakFiles/main/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/WaTaNTeaM/AntakFiles/main/AntakFiles/"..FileName)
if Res == 200 then
