...
keyboard = {} 
keyboard.inline_keyboard = {{{text="قفل الدردشه",callback_data="/LockText:"..data.sender_user_id_},{text="فتح الدردشه",callback_data="/unLockText:"..data.sender_user_id_}},{{text="قفل الدخول",callback_data="/Lockjoin:"..data.sender_user_id_},{text="فتح الدخول",callback_data="/unLockjoin:"..data.sender_user_id_}},{{text="قفل البوتات",callback_data="/LockBotList:"..data.sender_user_id_},{text="فتح البوتات",callback_data="/unLockBot:"..data.sender_user_id_}},{{text="قفل الاشعارات",callback_data="/LockTagServr:"..data.sender_user_id_},{text="فتح الاشعارات",callback_data="/unLockTagServr:"..data.sender_user_id_}},{{text="قفل التعديل",callback_data="/LockEditMsgs:"..data.sender_user_id_},{text="فتح التعديل",callback_data="/unLockEditMsgs:"..data.sender_user_id_}},{{text="قفل الملصقات",callback_data="/LockStickers:"..data.sender_user_id_},{text="فتح الملصقات",callback_data="/unLockStickers:"..data.sender_user_id_}},{{text="قفل المتحركه",callback_data="/LockGifs:"..data.sender_user_id_},{text="فتح المتحركه",callback_data="/unLockGifs:"..data.sender_user_id_}},{{text="قفل الفيديو",callback_data="/LockVideos:"..data.sender_user_id_},{text="فتح الفيديو",callback_data="/unLockVideos:"..data.sender_user_id_}},{{text="قفل الصور",callback_data="/unLockPhoto:"..data.sender_user_id_},{text="فتح الصور",callback_data="
unLockPhoto:"..data.sender_user_id_}},{{text="قفل التوجيه",callback_data="/LockForwards:"..data.sender_user_id_},{text="فتح التوجيه",callback_data="/unLockForwards:"..data.sender_user_id_}},{{text="قفل التكرار",callback_data="/LockSpamList:"..data.sender_user_id_},{text="فتح التكرار",callback_data="/unLockSpam:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/HelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
